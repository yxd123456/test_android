...
/** 
 * DAO for table "TOWER_TYPE".
*/
public class TowerTypeDao extends AbstractDao<TowerType, Long> {

    public static final String TABLENAME = "TOWER_TYPE";

    /**
     * Properties of entity TowerType.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property Scbz = new Property(3, Integer.class, "scbz", false, "SCBZ");
    ...
    public TowerTypeDao(DaoConfig config) {
        super(config);
    }
    
    public TowerTypeDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TOWER_TYPE\" (" + //
        ...
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_TOWER_TYPE__id ON TOWER_TYPE" +
                " (\"_id\");");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TOWER_TYPE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, TowerType entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public TowerType readEntity(Cursor cursor, int offset) {
        TowerType entity = new TowerType( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getInt(offset + 3), // scbz
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, TowerType entity, int offset) {
        ...
        entity.setScbz(cursor.isNull(offset + 3) ? null : cursor.getInt(offset + 3));
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(TowerType entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(TowerType entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
